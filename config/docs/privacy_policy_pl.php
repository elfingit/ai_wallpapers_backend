 ...
 return [
    ...
    Niniejsza Polityka Prywatności wyjaśnia, jak zbieramy, używamy, ujawniamy i chronimy Twoje informacje, gdy korzystasz z naszej aplikacji mobilnej ("Aplikacja").
		...
		[
			...
			'content' => '<p>Możemy zbierać informacje umożliwiające identyfikację osobistą na różne sposoby, między innymi, ale nie wyłącznie, gdy:</p>
<ul>
...
<p>
    Rodzaje zbieranych informacji mogą obejmować Twoje imię, adres e-mail, numer telefonu oraz wszelkie inne informacje, które zdecydujesz się nam dostarczyć.
		...
		[
			...
			'content' => '<p>Zebrane informacje mogą być wykorzystywane w następujących celach:</p>
<ul>
    ...
    <li>Do wysyłania do Ciebie e-maili</li>
		...
		[
			'title' => '4. Udostępnianie Twoich Informacji',
			'content' => '<p>Możemy udostępniać Twoje informacje stronie trzeciej w następujących sytuacjach:</p>
<ul>
    <li>Z Twoją zgodą</li>
    ...
    Jeśli jesteś rodzicem lub opiekunem i wiesz, że Twoje dziecko dostarczyło nam dane osobowe, prosimy o kontakt, abyśmy mogli podjąć odpowiednie działania.
		...
		[
			'title' => '8. Zmiany w tej Polityce Prywatności',
			'content' => '<p>
